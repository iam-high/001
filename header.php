...
<body>
    ...
    <div class="preloader">
        ...
        <img src="assets/logo/high-labs-logo-square.png" alt="slope-logo">
    </div>
    <!-- preloader - end -->
        ...
        <nav class="navigation enabled-sticky">
            <div class="navigation-bar">
                <div class="logo">
                    ...
                    rel="home" 
                    aria-current="page">
                        <img width="150" height="75" src="assets/logo/high-labs-logo.png" class="custom-logo" alt="Slope"></a>
                </div>
                <div class="hamburger ">
                    <a href="#">
                        <div class="bar"></div>
            ...
            <div class="navigation-menu">
                <div class="navigation-menu-image">
                    <img 
                        width="683" 
                        height="1037" 
                        src="assets/images/navigation_menu_image.png" 
                    ...
                    <div class="navigation-menu-menu--wrapper">
                        <ul class="menu">
                            ...
                            <li class="menu-item menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li class="menu-item">
                                        <a href="services-1.html">Service Style 1</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="services-2.html">Services Style 2</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="service-detailed.html">Service Detailed</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="menu-item menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li class="menu-item">
                                        <a href="projects-1.html">Projects Style 1</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="projects-2.html">Projects Style 2</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="project-detailed.html">Project Detailed</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="menu-item menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item">
                                        <a href="blog-detailed.html">Post Detailed</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
